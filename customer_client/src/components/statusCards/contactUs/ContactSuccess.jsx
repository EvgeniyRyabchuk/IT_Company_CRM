        ...
        <div>
            <Grid container spacing={3}>
                ...
                <Grid item xl={12} sm={12} md={6} lg={6}>
                    <FlexBoxCenter>
                        <Box>
                            <Typography variant='h3'>Your order will be processed as soon as possible</Typography>
                            <br/>
                            <hr/>
                            <br/>
                            <Typography sx={{mt: 1}} variant='subtitle1'>Thank you for contacting our company</Typography>
                        </Box>
                    </FlexBoxCenter>
                </Grid>
            </Grid>
