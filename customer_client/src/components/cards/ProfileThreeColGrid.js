...
const OurTeam = ({
  ...
  subheading = "Our Team",
  description = "Our team is a friendly team of professionals working on unique and interesting projects in the field of IT technologies and the boundless Internet space.",
  cards = [
    {
