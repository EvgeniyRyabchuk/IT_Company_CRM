...
export const showAxiosSuccessAlert = (primary: PrimaryErrorAlert.CREATED_NEWS | string) => {
    toast.success(primary,{ autoClose: 1500 });
}
/*

  toast.success(PrimarySuccessAlert.DELETED_NEWS);
